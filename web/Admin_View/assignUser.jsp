...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h2 class="card-title">Assign Member</h2>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <!--<form role="form">-->
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="reporting_manager" name="reporting_manager" onchange="getEmployee()">
                                                <option disabled="true" selected="true">Please Select</option>
                                            </select>
                                        </div>
        ...
        <script src="<%= request.getContextPath()%>/ajaxdata/assignUser.js"></script>
